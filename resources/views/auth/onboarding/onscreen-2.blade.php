...
@section('content')
    <div class="Onboarding-Screen-1-full">
        ...
        <div class="img">
            <img src="{{ asset('assets/image-new/ilustrasi/ilustrasi-2.png') }}" style="width: 100%;" alt="">
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center" style="margin-top: 60px;">
            <div class="btn-1">
                <a href="onboardscreen-1.html" class=""><svg xmlns="http://www.w3.org/2000/svg" width="24"
