@extends('user.test.components.base-test', ['title' => 'Soal 5'])
@section('content-test')
    <!-- Homepage2 Details Section Start -->
    <section id="test-sec">
        <div class="test-first-sec">
            <form id="questionForm" action="{{ route('soal-6', ['test' => $test]) }}" method="GET">
                <div class="question-sec">
                    <h2 class="question-sec-title">Mempunyai Riwayat Penyakit Jantung</h2>
                </div>
