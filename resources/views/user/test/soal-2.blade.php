@extends('user.test.components.base-test', ['title' => 'Soal 2'])
@section('content-test')
    <!-- Homepage2 Details Section Start -->
    <section id="test-sec">
        <div class="test-first-sec">
            <form id="questionForm" action="{{ route('soal-3', ['test' => $test]) }}" method="GET">
                <div class="question-sec">
                    <h2 class="question-sec-title">Tekanan Darah (Sistole) > 140</h2>
                </div>
