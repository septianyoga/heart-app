@extends('user.test.components.base-test', ['title' => 'Soal 6'])
@section('content-test')
    <!-- Homepage2 Details Section Start -->
    <section id="test-sec">
        <div class="test-first-sec">
            <form id="questionForm" action="{{ route('soal-7', ['test' => $test]) }}" method="GET">
                <div class="question-sec">
                    <h2 class="question-sec-title">Mempunyai Riwayat Penyakit Hiperkolesterol</h2>
                </div>
