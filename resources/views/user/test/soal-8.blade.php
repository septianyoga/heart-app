@extends('user.test.components.base-test', ['title' => 'Soal 8'])
@section('content-test')
    <!-- Homepage2 Details Section Start -->
    <section id="test-sec">
        <div class="test-first-sec">
            <form id="questionForm" action="{{ route('soal-9', ['test' => $test]) }}" method="GET">
                <div class="question-sec">
                    <h2 class="question-sec-title">Mempunyai Riwayat Stroke</h2>
                </div>
